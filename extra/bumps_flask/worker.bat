...
rem docker run -d -it --link redis-server --link rabbit-server -h oe_bumps_worker_w --name oe_bumps_worker_w bumps_base
rem docker run -d -it -h oe_bumps_worker_w --name oe_bumps_worker_w bumps_base
