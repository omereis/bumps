...
def get_next_job_id(connection):
    ...
    return job_id
##------------------------------------------------------------------------------
def get_sqlite_next_job_id(connection):
    job_id = 0
    try:
        sql = f'select max({fld_JobID}) from {tbl_bumps_jobs};'
