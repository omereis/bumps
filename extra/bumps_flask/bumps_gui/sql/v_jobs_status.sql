...
AS
	SELECT t_bumps_jobs.job_id AS 'job_id',sent_ip,sent_time,message,results_dir,job_status,end_time,problem_file,status_time,
			status_name,tag,chi_square
	FROM t_bumps_jobs,t_jobs_status WHERE t_bumps_jobs.job_id=t_jobs_status.job_id;
